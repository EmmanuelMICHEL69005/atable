class BotBooking
  ...
  def booking_confirmation
    ...
    Booking.create!(customer: @user, source: "Facebook", content: '', date: @day, number_of_customers: @nb_person, hour: @hour, status: "New", restaurant: Restaurant.find_by(name: 'Le Wagon Bar'))
